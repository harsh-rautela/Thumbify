    ...
    return (
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                   ...
                   <Link to='/generate' className="hover:text-pink-300 transition">Generate</Link>
                    {
                        isLoggedIn? <Link to='/my-generate' className="hover:text-pink-300 transition">My Generations</Link>:
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                 <Link to='/' className="hover:text-pink-300 transition" onClick={() => setIsOpen(false)}>Home</Link>
                 <Link to='/generate' className="hover:text-pink-300 transition" onClick={() => setIsOpen(false)}>Generate</Link>
                    {
                        isLoggedIn? <Link to='/my-generate' className="hover:text-pink-300 transition" onClick={() => setIsOpen(false)}>My Generations</Link>:
                        <Link to='#' className="hover:text-pink-300 transition" onClick={() => setIsOpen(false)}>About</Link>

                    }
                   <Link to='#' className="hover:text-pink-300 transition" onClick={() => setIsOpen(false)}>Contact Us</Link>   
                  {
                    isLoggedIn? 
