   ...
   const onDownload = ()=>{
    ...
    <div className='relative mx-auto w-full max-w-2xl '>
        <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
            ...
            {!isLoading && !thumbnail?.image_url && (
               <div className='  inset-0-2 m-2 flex flex-col items-center 
               justify-center gap-4 rounded-lg border-2 border-dashed border-white/20 bg-black/25 p-18'>
                ...
                <div className='px-4 text-center'>
                    ...
                    <p className='mt-1 text-xs text-zinc-400'>Fill out the form and click</p>
                </div>
               </div> 
            )}
        </div>
